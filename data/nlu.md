...
# intents chitchat
  ...
  - intent: informar_campus
    examples: |
      ...
      - Meu campus é [Barra de Sao Francisco](campus)	
...
# intents do ROD
  ...
  - intent: representantes_reunioes #003
    examples: |
      ...
      - O [líder de turma] deve participar de quais reuniões?
  ...
  - intent: revisao_notas_parciais #023
    examples: |
      ...
      - posso pedir a revisão da [nota] de uma [avaliação] que eu fiz
  ...
  - intent: trancamento_matricula_sobre #031
    examples: |
      ...
      - quero trancar a minha matrícula
  ...
  - intent: documentos_matricula #035
    examples: |
      ...
      - Quais documentos necessito para fazer minha matrícula?
  ...
  - intent: renovacao_matricula #039
    examples: |
      - a rematricula do [aluno] é automática?
  ...
  - intent: plano_ensino_contem #047
    examples: |
  ...
  - intent: oferta_cursos #050
    examples: |
      ...
      - os cursos estao divididos em [semestres], [bimestres] ou [trimestres]?
      - subsequente
      - concomitante
      - cursos subsequentes
  ...
  - intent: reintegracao_matricula_condicoes #058
    examples: |
      ...
      - em que situações posso pedir a reintegração da minha matrícula?
  ...
  - intent: pontuacao_trimestral #062
    examples: |
      ...
      - quantos [pontos] totais um trimestre pode ter?
  ...
  - intent: reuniao_pedagogica_intermediaria #067
    examples: |
      ...
      - sobre reuniao pedagogica intermediaria
  ...
  - intent: reuniao_pedagogica_membros #070
    examples: |
      ...
      - Eu posso ir pra uma reuniao pedagogica?
  ...
  - intent: corpo_discente #074
    examples: |
      ...
      - existe algum tipo de corpo discente ?
  ...
  - intent: tit_outras_atividades_ensino #084
    examples: |
      ...
      - Em qual parte do [Rod 2020] fala das outras atividades de ensino
  ...
  - intent: tit_intercambio_academico #088
    examples: |
      ...
      - Em qual parte do [Rod] 2020 fala do intercâmbio
...
### Assuntos gerais
  ...
  - intent: calendario_academico #11
    examples: |
...
# Sistema de chamados
  ...
  - intent: SC_certificado_conclusao_crea
    examples: |
      ...
      - como [faso] pra pedir certificado de conclusao para o crea [online]
  ...
  - intent: SC_nada_consta
    examples: |
      ...
      - Como consigo solicitar nada consta [pela internet]
      - Preciso solicitar nada consta urgente
      - Quero [fazer] solicitação de nada consta urgente
      - Quero solicitar nada consta [online]
      - Quero [fazer] pedido de nada consta [pela internet]
      - Quero [fazer] solicitação de nada consta [online]
  - intent: SC_regime_domiciliar
    examples: |
      - Como o [aluno] pode solicitar [regime domiciliar] [na internet]
      - Como o [estudante] solicita [regime domiciliar] [no site]
      - [Regime domiciliar] [online]
      - Pedido de [regime domiciliar] [pela internet]
      - Solicitação de [regime domiciliar] [na internet]
      - Solicitar [regime domiciliar] [no academico]
      - Tem como solicitar [regime domiciliar] via [internet]?
      - Tem como solicitar [regime domiciliar] [pela internet]?
      - Teria como eu [fazer] pedido de [regime domiciliar] [no sistema]?
      - [Fazer] pedido de [regime domiciliar] [online]
      - [Fazer] solicitação de [regime domiciliar] [online]
      - Como [peço] [regime domiciliar] [online]?
      - Como [fazer] pedido de [regime domiciliar] [pelo site]
      - Como solicitar [regime domiciliar] [pela internet]?
      - Como solicito [regime domiciliar] [pelo academico]?
      - Preciso solicitar [regime domiciliar] urgente
      - Quero [fazer] solicitação de [regime domiciliar] urgente
      - Quero solicitar [regime domiciliar] [online]
      - Quero [fazer] pedido de [regime domiciliar] [pela internet]
      - Quero [fazer] solicitação de [regime domiciliar] [online]
  - intent: SC_revisao_resultado_final
    examples: |
      - Como o [aluno] pode pedir revisão do resultado final [na internet]
      - Como o [estudante] solicita revisao de resultado final [no site]
      - Revisão do resultado final [online]
      - Revisão da nota final [online]
      - Pedido de revisão do resultado final [pela internet]
      - Solicitação de revisão da nota final [na internet]
      - Solicitar revisão do resultado final [no academico]
      - Tem como solicitar revisão do resultado final via [internet]?
      - Tem como solicitar revisão do resultado final [pela internet]?
      - Tem como solicitar que revisem meu resultado final [online]?
      - Teria como eu fazer pedido de revisão do resultado final[no sistema]?
      - [Fazer] pedido de revisão do resultado final [online]
      - [Fazer] solicitação de revisão do resultado final [online]
      - Como [peço] revisão do resultado final [online]?
      - Como [fazer] pedido de revisão do resultado final [pelo site]
      - Como solicitar revisão do resultado final [pela internet]?
      - Como solicito revisão da nota final [pelo academico]?
      - Preciso solicitar revisão do resultado final urgente
      - Quero fazer solicitação de revisão do resultado final urgente
      - Quero solicitar revisão do resultado final [online]
      - Quero [fazer] pedido de revisão do resultado final [pela internet]
      - Quero [fazer] solicitação de revisão do resultado final[online]
  - intent: SC_aproveitamento
    examples: |
      - Como o [aluno] pode pedir aproveitamento de disciplina [na internet]
      - Como o [estudante] solicita aproveitamento de disciplina [no site]
      - Aproveitamento de disciplinas cursadas [no sistema de chamados]
      - Aproveitamento de conhecimentos anteriores [no sistema de chamados]
      - Aproveitamento de experiências anteriores [no sistema de chamados]
      - Pedido de aproveitamento de disciplinas cursadas [pela internet]
      - Solicitação de aproveitamento de disciplinas cursadas  [na internet]
      - Solicitação de aproveitamento de experiências  [na internet]
      - Solicitação de aproveitamento de conhecimentos  [pela internet]
      - Solicitar aproveitamento de experiências  [no academico]
      - Solicitar aproveitamento de disciplinas cursadas  [no academico]
      - Solicitar aproveitamento de conhecimentos  [no academico]
      - Tem como solicitar aproveitamento de disciplinas cursadas  via [internet]?
      - Tem como solicitar aproveitamento de disciplinas cursadas  [pela internet]?
      - Tem como solicitar aproveitamento de experiência  via [internet]?
      - Tem como solicitar aproveitamento de conhecimento  [pela internet]?
      - Teria como eu [fazer] pedido de aproveitamento de disciplinas cursadas  [no sistema]?
      - Teria como eu [fazer] pedido de aproveitamento de experiencia  [no sistema]?
      - Teria como eu [fazer] pedido de aproveitamento de conhecimento [no sistema]?
      - [Fazer] pedido de aproveitamento de disciplinas cursadas [online]
      - [Fazer] pedido de aproveitamento de conhecimentos anteriores [online]
      - [Fazer] pedido de aproveitamento de experiências anteriores [online]
      - [Fazer] solicitação de aproveitamento de disciplinas cursadas [online]
      - [Fazer] solicitação de aproveitamento de conhecimentos anteriores [online]
      - [Fazer] solicitação de aproveitamento de experiências anteriores [online]
      - Como [peço] aproveitamento de disciplinas cursadas [online]?
      - Como [peço] aproveitamento de conhecimentos anteriores [online]?
      - Como [peço] aproveitamento de experiencias anteriores [online]?
      - Como [fazer] pedido de aproveitamento de disciplinas cursadas [pelo site]
      - Como [fazer] pedido de aproveitamento de conhecimentos anteriores [pelo site]
      - Como [fazer] pedido de aproveitamento de experiencias anteriores [pelo site]
      - Como solicitar aproveitamento de disciplinas cursadas [pela internet]?
      - Como solicitar aproveitamento de conhecimentos anteriores [pela internet]?
      - Como solicitar aproveitamento de experiencia anteriores [pela internet]?
      - Como solicito aproveitamento de disciplinas cursadas [pelo academico]?
      - Como solicito aproveitamento de conhecimentos anteriores [pelo academico]?
      - Como solicito aproveitamento de experiencias anteriores [pelo academico]?
      - Quero [fazer] solicitação de aproveitamento de conhecimentos anteriores urgente
      - Quero [fazer] solicitação de aproveitamento de disciplinas cursadas urgente
      - Quero [fazer] solicitação de aproveitamento de experiencias anteriores urgente
      - Quero solicitar aproveitamento de disciplinas cursadas [online]
      - Quero solicitar aproveitamento de conhecimentos anteriores [online]
      - Quero solicitar aproveitamento de experiencias anteriores [online]
      - Quero [fazer] pedido de aproveitamento de disciplinas cursadas [pela internet]
      - Quero [fazer] pedido de aproveitamento de conhecimentos anteriores [pela internet]
      - Quero [fazer] pedido de aproveitamento de experiencias anteriores[pela internet]
...
## sinonimos
  ...
  - synonym: ead
    examples: |
      ...
      - ensido a distancia
      - apnp
      - Atividade pedagógica não presencial
      - Atividades pedagógicas não presencial
  ...
  - synonym: NE
    examples: |
      ...
      - portador de necessidades especificas
      - portadora de necessidades especiais
      - portadora de necessidades especificas
  ...
  - synonym: rematrícula
    examples: |
      ...
      - renovacao da matricula
      - renovação de matricula
      - renovasao de matricula
      - revasaum de matricula
      - rematrícula
      - rematricula
      - re-matricula
      - re matricula
  - synonym: regime domiciliar
    examples: |
      - regime domiciliar
  ...
  - synonym: rod
    examples: |
      ...
      - regulamento da organizacao didatica
      - rod2020
      - rod 2020
      - normas
      - regulamento
